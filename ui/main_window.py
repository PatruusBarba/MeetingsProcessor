...
class MainWindow:
    ...
    def _start_recording(self) -> None:
        ...
        ok, err = self._engine.start(
            ...
            transcription_segment_sec=float(self._config.get("transcription_segment_sec") or 3.0),
            transcription_overlap_sec=float(self._config.get("transcription_overlap_sec") or 0.75),
